...
class Palette {
  ...
  static const cardBackgroundInactive = Color(0xFF121428); // Slightly lighter dark color

  // Background color for active cards (e.g., when selected)
  static const cardBackgroundActive = Color(0xFF1D1F33); // Darker shade for active state
  ...
  static const normalResult = Color(0xFF4BE57A); // Green color for normal results

  // Color representing an underweight BMI result
  static const underweightResult = Color(0xFFE5D94B); // Yellow color for underweight results

  // Color representing an overweight BMI result
  static const overWeightResult = Color(0xFFE54B4B); // Red color for overweight results
}
